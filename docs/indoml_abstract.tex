...
% --- TITLE & AUTHOR INFO ---
\title{\vspace{-1.2em}\textbf{\Large Computational Formalization and Reinforcement Learning Baselines for Assamese Traditional Games: A Case Study on Kori Khel}\vspace{-0.5em}}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.88\textwidth,height=1.8in,keepaspectratio]{../evaluation/kori_khel/plots/training_curves_comparison.png}
...
\begin{tabular}{@{} l c c @{}}
\toprule
\textbf{Metric} & \textbf{Standard PPO (1M)} & \textbf{Maskable PPO (2M)} \\
\midrule
...
\begin{figure}[h]
\centering
\includegraphics[width=0.92\linewidth,height=1.5in,keepaspectratio]{../evaluation/kori_khel/plots/ppo_vs_maskable_comparison.png}
\caption{Head-to-Head 1,000-Game Benchmark Comparison.}
