...
% --- TITLE & AUTHOR INFO ---
\title{\vspace{-1.2em}\textbf{\Large Computational Formalization and Reinforcement Learning Baselines for Assamese Traditional Games: A Case Study on Kori Khel}\vspace{-0.4em}}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.85\textwidth]{../evaluation/kori_khel/plots/training_curves_comparison.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.92\linewidth]{../evaluation/kori_khel/plots/ppo_vs_maskable_comparison.png}
