...
\begin{figure*}[t]
\centering
\includegraphics[width=0.92\textwidth]{../evaluation/kori_khel/plots/training_curves_comparison.png}
\caption{Training Trajectory Comparison over 2.0 Million Timesteps showing moving average reward and episode length convergence.}
