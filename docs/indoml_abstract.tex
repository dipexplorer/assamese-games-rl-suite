...
% --- TITLE & AUTHOR INFO ---
\title{Computational Formalization and Reinforcement Learning Baselines for Assamese Traditional Games: A Case Study on Kori Khel}
...
\begin{table}[htbp]
\centering
\caption{Head-to-head benchmark performance over 1,000 matches (Standard PPO: 1.0M, Maskable PPO: 2.0M).}
\label{tab:results}
\resizebox{\linewidth}{!}{%
\begin{tabular}{lcc}
\toprule
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\linewidth]{../evaluation/kori_khel/plots/ppo_vs_maskable_comparison.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.0\linewidth]{../evaluation/kori_khel/plots/training_curves_comparison.png}
